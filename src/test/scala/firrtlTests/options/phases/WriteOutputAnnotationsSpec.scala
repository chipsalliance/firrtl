...
import firrtl.options.{OutputAnnotationFileAnnotation, InputAnnotationFileAnnotation, WriteDeletedAnnotation}
...
class WriteOutputAnnotationsSpec extends FlatSpec with Matchers with firrtlTests.Utils {
  ...
  it should "write annotations to a file (excluding DeletedAnnotations)" in {
  ...
  it should "include DeletedAnnotations if a WriteDeletedAnnotation is present" in {
