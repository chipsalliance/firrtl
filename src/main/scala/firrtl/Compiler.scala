...
// todo deprecate this?
trait FormAPIMigration { this: Transform =>
...
abstract class SeqTransform extends Transform with SeqTransformBased with FormAPIMigration {
...
trait Compiler extends Transform {
  def emitter: Emitter
