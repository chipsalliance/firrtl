...
/** Replace DefAnnotatedMemory with memory blackbox + wrapper + conf file.
  ...
  */
@deprecated("ReplaceMemMacros will not take writer: ConfWriter as argument since 1.5.", "1.4")
class ReplaceMemMacros(writer: ConfWriter) extends Transform with DependencyAPIMigration {
  ...
  @deprecated("memToBundle will become private in 1.5.", "1.4")
  ...
  @deprecated("memToFlattenBundle will become private in 1.5.", "1.4")
  ...
  /** Creates a wrapper module and external module to replace a candidate memory
    ...
    *  The external module
    */
  @deprecated("createMemModule will become private in 1.5.", "1.4")
  ...
  @deprecated("defaultConnects will become private in 1.5.", "1.4")
  ...
  @deprecated("maskBits will become private in 1.5.", "1.4")
  ...
  @deprecated("adaptReader will become private in 1.5.", "1.4")
  ...
  @deprecated("adaptWriter will become private in 1.5.", "1.4")
  ...
  @deprecated("adaptReadWriter will become private in 1.5.", "1.4")
  ...
  @deprecated("constructNameMap will become private in 1.5.", "1.4")
  ...
  @deprecated("updateMemStmts will be private in 1.5.", "1.4")
  def updateMemStmts(
    namespace:  Namespace,
    nameMap:    NameMap,
    mname:      String,
  ...
  @deprecated("updateMemMods will be private in 1.5.", "1.4")
