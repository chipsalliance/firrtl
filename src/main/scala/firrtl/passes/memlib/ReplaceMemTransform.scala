...
"""
    ...
    val outputConfig =
      passOptions.getOrElse(OutputConfigFileName, error("No output config file provided for ReplSeqMem!" + usage))
...
@deprecated("Migrate to a transform that does not take arguments. This will be removed in 1.4.", "FIRRTL 1.3")
