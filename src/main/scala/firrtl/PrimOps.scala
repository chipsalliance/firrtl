  ...
  def set_primop_type(e: DoPrim): DoPrim = {
    ...
    e copy (tpe = e.op match {
      ...
      case AsInterval => t1 match {
        case _: UIntType     => IntervalType(Closed(BigDecimal(o1)/BigDecimal(BigInt(1) << o3.toInt)), Closed(BigDecimal(o2)/BigDecimal(BigInt(1) << o3.toInt)), IntWidth(o3))
        case _: SIntType     => IntervalType(Closed(BigDecimal(o1)/BigDecimal(BigInt(1) << o3.toInt)), Closed(BigDecimal(o2)/BigDecimal(BigInt(1) << o3.toInt)), IntWidth(o3))
        case _: FixedType    => IntervalType(Closed(BigDecimal(o1)/BigDecimal(BigInt(1) << o3.toInt)), Closed(BigDecimal(o2)/BigDecimal(BigInt(1) << o3.toInt)), IntWidth(o3))
        case ClockType       => IntervalType(Closed(BigDecimal(o1)/BigDecimal(BigInt(1) << o3.toInt)), Closed(BigDecimal(o2)/BigDecimal(BigInt(1) << o3.toInt)), IntWidth(o3))
        case _: AnalogType   => IntervalType(Closed(BigDecimal(o1)/BigDecimal(BigInt(1) << o3.toInt)), Closed(BigDecimal(o2)/BigDecimal(BigInt(1) << o3.toInt)), IntWidth(o3))
        // Chisel shifts up and rounds first.
        case _: IntervalType => IntervalType(Closed(BigDecimal(o1)/BigDecimal(BigInt(1) << o3.toInt)), Closed(BigDecimal(o2)/BigDecimal(BigInt(1) << o3.toInt)), IntWidth(o3))
        case _ => UnknownType
      }
      ...
      case Shr => t1 match {
        ...
        case IntervalType(l, u, p) => 
          val shiftMul = Closed(BigDecimal(1) / BigDecimal(BigInt(1) << o1.toInt))
