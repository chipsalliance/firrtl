...
object PrimOps extends LazyLogging {
  ...
  private lazy val builtinPrimOps: Seq[PrimOp] =
    Seq(Add, Sub, Mul, Div, Rem, Lt, Leq, Gt, Geq, Eq, Neq, Pad, AsUInt, AsSInt, AsInterval, AsClock,
      AsAsyncReset, Shl, Shr, Dshl, Dshr, Neg, Cvt, Not, And, Or, Xor, Andr, Orr, Xorr, Cat, Bits,
      Head, Tail, AsFixedPoint, BPShl, BPShr, BPSet, Wrap, Clip, Squeeze)
...
//  }
  ...
  // THIS IS THE ORGINAL VERSION OF set_primop_type (PRE-INTERVAL)
  /*
