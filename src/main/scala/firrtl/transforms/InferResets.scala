...
/** Infers the concrete type of [[firrtl.ir.ResetType]]s by their connections
  *
  * There are 3 cases
  ...
  * @note This is a global inference because ports can be of type [[firrtl.ir.ResetType]]
