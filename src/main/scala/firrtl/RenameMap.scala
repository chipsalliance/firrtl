...
object RenameMap {
  //@deprecated(Use create with CompleteTarget instead, this will be removed in 1.4", "1.3")
...
final class RenameMap private (val underlying: mutable.HashMap[CompleteTarget, Seq[CompleteTarget]] = mutable.HashMap[CompleteTarget, Seq[CompleteTarget]](), val chained: Option[RenameMap] = None) {
  ...
  /** Create new [[RenameMap]] that merges this and renameMap
    ...
    * @return
    */
  //@deprecated(will be removed in 1.4", "1.3")
  ...
  //@deprecated(Use record with CircuitTarget instead, this will be removed in 1.4", "1.3")
  def rename(from: Named, to: Named): Unit = rename(from, Seq(to))

  //@deprecated(Use record with IsMember instead, this will be removed in 1.4", "1.3")
  ...
  //@deprecated(Use delete with CircuitTarget instead, this will be removed in 1.4", "1.3")
  def delete(name: CircuitName): Unit = underlying(name) = Seq.empty

  //@deprecated(Use delete with IsMember instead, this will be removed in 1.4", "1.3")
  def delete(name: ModuleName): Unit = underlying(name) = Seq.empty

  //@deprecated(Use delete with IsMember instead, this will be removed in 1.4", "1.3")
  def delete(name: ComponentName): Unit = underlying(name) = Seq.empty

  //@deprecated(Use recordAll with CompleteTarget instead, this will be removed in 1.4", "1.3")
  ...
  //@deprecated(Use get with CircuitTarget instead, this will be removed in 1.4", "1.3")
  ...
  //@deprecated(Use get with IsMember instead, this will be removed in 1.4", "1.3")
  ...
  /** Sets mutable state to record current module we are visiting
    * @param module
    */
  //@deprecated(Use typesafe rename defs instead, this will be removed in 1.4", "1.3")
