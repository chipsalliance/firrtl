...
The bit representation contains a binary or hex indicator, followed by an optional sign, followed by the value.
...
\pd{stmt}       &=     &\vv{wire} \pd{id} \vv{:} \pd{type} \opt{\pd{info}}                                     &\text{Wire}\\
                ...
                &\pipe &\vv{attach}\vv{(}\rpt{\pd{exp}}\vv{)}                                                  &\text{Attach}\\
