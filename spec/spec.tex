...
\subsubsection{Behavioral Memory Access Statements}
...
\subsubsection{Inferred Memory Accessors}

Once an inferred memory accessor is declared, write operations can also be performed using the connection statement.
Intuitively, when the port is used on the left-hand side of an assignment, this corresponds to connecting the right-hand side of the assignment to the `data` field of an explicit write port and asserting that port's `en` signal.
