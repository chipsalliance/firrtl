...
For the purpose of defining such collisions, an ``active write port'' is either a write port or readwrite port that is used to initiate a write operation on a given clock edge.
An ``active read port'' is a read port or readwrite port that is used to initiate a read operation on a given clock edge.
